...
if(sh src/tests/regression/../../.././libtool --mode=execute src/tests/regression/../../.././src/programs/sphinx3_decode $margs $lmargs  > $tmpout 2>&1 ); \
then echo "DECODE MODE 1368 (DO NOTHING MODE) test PASSED" ; else \
echo "DECODE MODE 1368 (DO NOTHING MODE) test FAILED" ; fi
