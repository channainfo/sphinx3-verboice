...
tmpout="test-decode-mode3-mulmpx.out"

echo "DECODE MODE 3 MULTIPLE PHONE MPX TEST"
...
then echo "DECODE MODE 3 MULTIPLE PHONE MPX test PASSED" ; else \
echo "DECODE MODE 3 MULTIPLE PHONE MPX test FAILED" ; fi
